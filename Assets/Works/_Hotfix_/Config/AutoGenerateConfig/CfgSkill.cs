...
namespace Hotfix
{
	...
	public partial class CfgSkill : AssetConfig
	{
		...
		public void Create()
		{
			AddElement(1001, new CfgSkillTab(1001, "普通攻击", 1002, "", 0.9f, 1f, 0, 0.2f, 100f, 2f));
			AddElement(1002, new CfgSkillTab(1002, "跳跃", 1005, "", 1.2f, 1f, 0, 0.8f, 50f, 4f));
			AddElement(1003, new CfgSkillTab(1003, "盾牌防守", 1004, "", 1f, 5f, 0, 0f, 0f, 0f));
		}
	}
}
