...
{
    unsafe class UnityEngine_TransformExtension_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.TransformExtension);
            args = new Type[]{typeof(UnityEngine.Transform), typeof(System.String)};
            method = type.GetMethod("FindChildByName", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, FindChildByName_0);


        }


        static StackObject* FindChildByName_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UnityEngine.TransformExtension.FindChildByName(@root, @childName);
