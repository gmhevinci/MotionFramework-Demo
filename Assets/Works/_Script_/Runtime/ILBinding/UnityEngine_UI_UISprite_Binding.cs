...
{
    unsafe class UnityEngine_UI_UISprite_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.UI.UISprite);
            args = new Type[]{};
            method = type.GetMethod("get_SpriteName", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_SpriteName_0);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("set_SpriteName", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_SpriteName_1);
